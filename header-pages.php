...
<head>
    ...
    <link href="//db.onlinewebfonts.com/c/e63653407669814f5b0eb9bbdc175f77?family=Microsoft+YaHei" rel="stylesheet" type="text/css"/>
            ...
            <div class="medium-10 small-12 cell ">
                <div class="menu-wrapper">
                    <?php if ( has_nav_menu( 'header-menu' ) ) : ?>
                        <div class="title-bar hide-for-medium align-right" data-responsive-toggle="main-menu" data-hide-for="medium">
                        ...
                        <?php if (have_rows('header_links', 'options')) : ?>
                            <div class="header__links-wrapper flex-container align-middle hide-for-small-only">
                                ...
                                <a href="#" class="search-btn fa" data-btn="search">
