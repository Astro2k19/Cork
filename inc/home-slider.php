			...
			<?php while ( $slider->have_posts() ) : $slider->the_post(); ?>
				<div class="slick-slide home-slide">
					<div class="home-slide__inner" <?php bg( get_attached_img_url( get_the_ID(), 'full_hd' ) ); ?>>
						<div class="grid-container home-slide__caption">
							<div class="grid-x grid-margin-x">
								<div class="cell text-center">
                                    <div class="home-slide__content-wrapper">
                                        <div class="home-slide__content">
                                            <h1><?php the_title(); ?></h1>
                                            <?php the_content(); ?>
                                        </div>
                                        <?php if (have_rows('slider_features')) : ?>
                                            <ul class="home-slide__repeater">
                                                <?php while (have_rows('slider_features')) : the_row();
                                                    $slider_feature = get_sub_field('feature_content');
                                                    ?>
                                                    <li class="home-slide__repeater-item">
                                                        <?=$slider_feature?>
                                                    </li>
                                                <?php endwhile ?>
                                            </ul>
                        ...
                        <div class="page-down">
                            <img src="<?= get_template_directory_uri() . '/assets/images/pagedown.png' ?>" alt="">
                        </div>
					</div>
